...
# NEBIUS_TENANT_ID=tenant-e00n8mpcqrjw1ehff0
# NEBIUS_PROJECT_ID=project-e00bq3stpr009arc9j3hqq # hj-tenant1-project1-eu-north1, projects are region-bound
# NEBIUS_REGION=eu-north1

# --- us-central1 (H200 test) ---
NEBIUS_TENANT_ID=tenant-e00n8mpcqrjw1ehff0
NEBIUS_PROJECT_ID=project-u00rpx09pr003ap0ehc79j # hj-tenant1-project1, projects are region-bound
